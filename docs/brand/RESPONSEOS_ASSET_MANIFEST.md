...
| `public/favicon-16.png` | 16×16 | Black | Browser micro-icon | Compact mark cropped to its content bounds, drawn 14×8 (rebuilt 2026-09-11) | Passed at 16px |
| `public/favicon-32.png` | 32×32 | Black | Browser icon | Compact mark cropped to its content bounds, drawn 28×15 (rebuilt 2026-09-11) | Passed at 32px |
| `public/favicon-48.png` | 48×48 | Black | Browser icon | Compact mark cropped to its content bounds, drawn 42×23 (rebuilt 2026-09-11) | Passed at 48px |
| `public/favicon.ico` | 16/32/48 | Black | Multi-resolution browser icon | Embeds the three rebuilt PNG frames above | Passed |
...
| `public/og/responseos-og.png` | 1200×630 | Black | Open Graph/Twitter card | Supplied wordmark embedded in `public/og/responseos-og.svg`, rasterized by `scripts/generate-og.mjs`; headline copy unchanged | Passed |
...
- Crop the compact mark to its content bounds before resizing small frames. The first 16px and 32px derivatives (2026-08-17) resized the whole 500×500 canvas, drew the mark in 8×4 and 16×8 pixels, and did not read at tab size.
