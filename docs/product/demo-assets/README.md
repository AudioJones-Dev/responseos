...
the sales-facing wrapper in [`../responseos-demo-landing-page-copy.md`](../responseos-demo-landing-page-copy.md),
and the live-call bridge in [`../responseos-sales-call-talk-track.md`](../responseos-sales-call-talk-track.md).
