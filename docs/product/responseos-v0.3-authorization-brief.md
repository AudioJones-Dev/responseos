...
**Status:** Decision-support brief. **Mock-only CAL interface scaffolding (§1) is pre-authorized by ADR-0040.** Live provider work still begins only with a separate, explicit, written authorization referencing Gate Set B in [`../ops/RESPONSEOS_V0_3_READINESS_GATES.md`](../ops/RESPONSEOS_V0_3_READINESS_GATES.md).
**Added:** 2026-06-03 · **Updated:** 2026-08-06 (ADR-0040)
