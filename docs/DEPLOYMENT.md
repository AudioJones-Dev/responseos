...
> **Hard rule:** do NOT promote a **live-provider / Gate Set B** production deploy until [`ops/RESPONSEOS_V0_3_READINESS_GATES.md`](./ops/RESPONSEOS_V0_3_READINESS_GATES.md) Gate Set B clears and live v0.3 is explicitly authorized. A **mock-safe demo deploy** (Gate Set A, ADR-0040) is the allowed near-term path — see [`ops/RESPONSEOS_DEMO_DEPLOY_RUNBOOK.md`](./ops/RESPONSEOS_DEMO_DEPLOY_RUNBOOK.md).
>
