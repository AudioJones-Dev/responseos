...
- [`RESPONSEOS_CANON_RECONCILIATION.md`](./RESPONSEOS_CANON_RECONCILIATION.md)
  ...
  remaining unknowns.
- [`RESPONSEOS_CLIENT_ACTIVATION_RECONCILIATION.md`](./RESPONSEOS_CLIENT_ACTIVATION_RECONCILIATION.md)
  — current-state reconciliation of the client-activation substrate against the
