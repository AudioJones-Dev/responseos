...
- **Live provider integrations are still gated to v0.3 Gate Set B.** No Twilio / Retell / Vapi / Stripe / GHL / HubSpot calls run against real accounts from this repo. Mock-safe demo deploys follow Gate Set A ([`docs/ops/RESPONSEOS_V0_3_READINESS_GATES.md`](./docs/ops/RESPONSEOS_V0_3_READINESS_GATES.md), ADR-0040).
...
- No live-provider (Gate Set B) deploys until [`docs/ops/RESPONSEOS_V0_3_READINESS_GATES.md`](./docs/ops/RESPONSEOS_V0_3_READINESS_GATES.md) clears; mock-safe Gate Set A demo deploys follow ADR-0040.
