...
/**
 * The shared capability contract (ADR-0058).
 *
 ...
 * registry) are deliberately absent. ADR-0058 decision 8: generalize from two
 ...
 * collision ADR-0058 decision 9 exists to prevent. Two values because two
...
export interface CapabilityDescriptor {
   ...
   * can be reused by mistake and a checksum cannot (ADR-0058 q5).
   */
